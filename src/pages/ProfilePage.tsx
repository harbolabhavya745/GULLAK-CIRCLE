              ...
              {isEditingName ? (
                <div className="flex items-center gap-1.5">
                  <input
                    ...
                    maxLength={60}
                    className="text-2xl font-bold text-slate-100 font-sans tracking-tight bg-matte-black border border-gold-500/30 rounded-xl px-2 py-1 outline-none focus:border-gold-500/60 disabled:opacity-50 w-48"
                  />
                  <button
                    type="button"
                    ...
                    className="p-1.5 rounded-lg bg-gold-500/10 text-gold-500 hover:bg-gold-500/20 transition-colors disabled:opacity-50"
                  >
                    {isSavingName ? (
                  ...
                  <button
                    ...
                    disabled={isSavingName}
                    aria-label="Cancel"
                    className="p-1.5 rounded-lg bg-slate-500/10 text-slate-400 hover:bg-slate-500/20 transition-colors disabled:opacity-50"
                  >
                ...
                <div className="flex items-center gap-2 group">
                  ...
                  {onUpdateName && (
                    <button
                      ...
                      className="p-1 rounded-lg text-slate-500 hover:text-gold-500 hover:bg-gold-500/10 transition-all opacity-60 group-hover:opacity-100"
                    >
